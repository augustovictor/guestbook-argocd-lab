...
silent only
silent tabonly
cd ~/projects/personal/guestbook-argocd-lab
...
badd +8 deployment/overlay-configs/dev/git-source.yml
argglobal
%argdel
$argadd NvimTree_1
...
enew
file NERD_tree_2
balt deployment/base-configs/kustomization.yml
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
2wincmd w
wincmd =
if exists(':tcd') == 2 | tcd ~/projects/personal/guestbook-argocd-lab | endif
tabnext 1
